...
/* Token Declaration */
%token LPAREN RPAREN LBRACE RBRACE COMMA LSQBRACE RSQBRACE LPOINTY RPOINTY COLON SEMI ACCESS LENGTH TABLEACCESS TABLEAPPEND INPUT OUT
...
expr:
  ...
  | LENGTH LPAREN expr RPAREN
                          { Length($3) }
  | INPUT LPAREN STRING_LIT RPAREN
                          { In($3)                  }
